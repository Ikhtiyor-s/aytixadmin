...
export const COMPANY_TYPE_LABELS: Record<string, Record<string, string>> = {
...
export const INTEGRATION_TRANSLATIONS: Record<string, { ru: string; en: string }> = {
  // CRM
  amocrm: {
...
export function getDesc(integration: typeof AVAILABLE_INTEGRATIONS[0], lang: Language): string {
